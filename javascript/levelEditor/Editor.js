...
function Editor() {
  ...
  this.showElements = function() {
    ...
    //para cada elemento do array 'elements', ele cria uma div e define o nome da classe
  ...
  that.gridMedium = function() {
    view.remove(gameWorld, grid);
    that.drawGrid(3840); //tamanho médio da grade
  };

  that.gridLarge = function() {
    view.remove(gameWorld, grid);
    that.drawGrid(6400); // tamanho pequeno da grade
  };
  ...
  this.saveMap = function() {
    ...
    //para corrigir a ordenação do localStorage, 01 02 ... 10 11, caso contrário a ordenação seria 1 10 11 .. 2 20 21 ..
    if (levelCounter < 10) {
